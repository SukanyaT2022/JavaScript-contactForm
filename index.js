...
function displayContact() {
  ...
  for (i = 0; i < objArray.length; i++) {
    ...
    button.setAttribute(
      'onclick',
      'deleteObjButton(' + objArray[i].contactID + ')'
    );
...
// Get the button submit ID
var btn = document.getElementById('myBtn');
// Get the button refresh
var refeshBtn = document.getElementById('refresh');
// Get the <span> element that closes the modal
var span = document.getElementsByClassName('close')[0];


//refresh button
refeshBtn.onclick = function () {
...
function updateUserFunc() {
  ...
  displayContact();
  document.getElementById('updateUserInfo').value = ''
}
